    ...
    <div className="shadow-md shadow-cyan-700 px-10 pt-5 md:py-4 sm:pt-20 ">
      <nav className=" flex flex-col lg:flex lg:flex-row lg:justify-between  ">
        <div className="flex  justify-between">
            ...
            <Link  to='/' smooth={true} duration={500}  offset={-125} className="flex text-4xl font-bold cursor-pointer ">
        ...
        >
          {links.map((link) => {
            return (
              <div key={link.name}  className={`${Open ? "py-1 pb-2 visible" : "invisible"} lg:visible `}>
              
                  <Link to={link.Link} smooth={true} duration={500}  offset={-125} className=" hover:text-cyan-700">
